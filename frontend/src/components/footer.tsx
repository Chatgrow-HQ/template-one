  ...
  return (
    <footer className="site-footer">
      <MotionReveal className="site-container site-footer__grid">
        <div>
          <Link to="/" className="site-brand"><BrandMark /></Link>
        ...
        <div><h3>Explore</h3><ul><li><Link to="/about-us">About us</Link></li><li><Link to="/services">Services</Link></li><li><Link to="/gallery">Tour gallery</Link></li><li><Link to="/faq">FAQs</Link></li></ul></div>
