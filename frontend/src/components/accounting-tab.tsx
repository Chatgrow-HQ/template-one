...
export default function AccountingTab(){
    ...
    let loadFile =(e:any)=>{
        var image = document.getElementById(e.target.name) as HTMLImageElement | null;
                    ...
                    <div className="profile-pic text-center mb-5">
                        ...
                        <div>
                            <div className="relative h-28 w-28 mx-auto">
                                <img src={clientImg} className="rounded-full shadow-sm dark:shadow-gray-800 ring-4 ring-slate-50 dark:ring-slate-800" id="profile-image" alt=""/>
