                    ...
                    <div className="registration-form text-dark text-start">
                        <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <div className="relative mt-2">
                                    <FiCalendar className="size-4.5 absolute top-2.5 inset-s-3 z-50"></FiCalendar>
                                    <DatePicker className="w-full py-2 px-3 ps-10 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-md outline-none border border-gray-100 dark:border-gray-800 focus:ring-0 start" selected={startDate} onChange={(date: Date | null) => setStartDate(date)} />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative mt-2">
                                    <FiCalendar className="size-4.5 absolute top-2.5 inset-s-3 z-50"></FiCalendar>
                                    <DatePicker className="w-full py-2 px-3 ps-10 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded-md outline-none border border-gray-100 dark:border-gray-800 focus:ring-0 start" selected={startDate2} onChange={(date: Date | null) => setStartDate2(date)} />
                                </div>
                            </div>
