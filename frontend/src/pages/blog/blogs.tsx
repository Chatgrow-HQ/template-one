...
export default function Blog() { return <div className="site-page"><Navbar/><main>
  <PageHero kicker="Skyways travel journal" title="Useful ideas for better journeys." copy="Clear destination guides, practical travel advice, and inspiration for your next domestic or international trip." image={parisImage} imageAlt="Students exploring Paris with a local guide"/>
