                                ...
                                <div className="md:flex justify-between">
                                    <div>
                                        ...
                                        <div className="flex mt-4">
                                            ...
                                            <Link to="#" target="_blank" className="text-primary dark:text-white font-medium">www.travosy.com</Link>
                                        </div>
                                    </div>
                                ...
                                <div className="mt-3 md:w-56">
                                    <ul className="list-none">
                                        <li className="flex mt-3">
                                            ...
                                            <span className="text-slate-400">15th Oct, 2027</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div className="md:flex justify-between">
                                    <div>
                                        <div className="text-slate-400 text-center md:text-start">
                                            <h6 className="mb-0">Customer Services : <Link to="tel:+152534-468-854" className="text-primary">(+12) 1546-456-856</Link></h6>
                                        </div>
                                    </div>

                                    <div className="mt-4 md:mt-0">
                                        <div className="text-slate-400 text-center md:text-end">
                                            <h6 className="mb-0"><Link to="/terms" target="_blank" className="text-primary">Terms & Conditions</Link></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
