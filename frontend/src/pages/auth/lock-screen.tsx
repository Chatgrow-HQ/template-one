...
export default function LockScreen(){
    return(
        ...
        <section className="md:h-screen py-36 flex items-center bg-[url('../../assets/images/bg/6.jpg')] bg-no-repeat bg-center bg-cover">
            <div className="absolute inset-0 bg-linear-to-b from-transparent to-slate-900"></div>
            <div className="container relative">
                <div className="flex justify-center">
                    <div className="max-w-100 w-full m-auto p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-800 rounded-md">
                        <div className="text-center">
                            <img src={user} className="mx-auto h-28 w-28 rounded-full shadow-sm dark:shadow-gray-800" alt=""/>
