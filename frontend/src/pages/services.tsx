...
export default function Services() { return <div className="site-page"><Navbar/><main>
  <PageHero kicker="Our services" title="Everything you need to travel well." copy="Book one service or let Skyways coordinate the complete journey. Every option is presented clearly, with a real team available to help." image={parisImage} imageAlt="Students on a Skyways education-through-travel concept trip in Paris" action={<Link className="site-button" to="/contact-us">Request a travel plan <FiArrowRight/></Link>}/>
