...
export default function IndexTwo(){
    return(
        ...
        <section className="swiper-slider-hero relative block h-screen" id="home">
            <div className="swiper-container absolute inset-e-0 top-0 w-full h-full">
                <Swiper className="swiper-wrapper" loop={true} speed={2000} autoplay={{delay:6500}} effect="flip" modules={[Autoplay,EffectFade ]}>
                    <SwiperSlide className="swiper-slide flex items-center overflow-hidden">
                        <div className="slide-inner absolute inset-e-0 top-0 w-full h-full slide-bg-image flex items-center bg-center" style={{backgroundImage:`url(${bg2})`}}>
                            <div className="absolute inset-0 bg-slate-900/70"></div>
                            <div className="container relative">
                                <div className="grid grid-cols-1">
                                    <div className="text-center">
                                        <img src={map} className="mx-auto w-75" alt=""/>
                                        ...
                                        <div className="mt-6">
                                            <Link to="" className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-primary text-white rounded-md">See More</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <SwiperSlide className="swiper-slide flex items-center overflow-hidden">
                        <div className="slide-inner absolute inset-e-0 top-0 w-full h-full slide-bg-image flex items-center bg-center" style={{backgroundImage:`url(${bg3})`}}>
                            <div className="absolute inset-0 bg-slate-900/70"></div>
                            <div className="container relative">
                                <div className="grid grid-cols-1">
                                    <div className="text-center">
        ...
        <section className="relative md:pb-24 pb-16 overflow-hidden">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 mt-6 gap-6">
                    {packages.slice(0,8).map((item:PackageData,index:number)=>{
                        return(
