...
export default function IndexFour(){
    ...
    return(
        ...
        <section className="relative py-36  bg-cover jarallax" style={{backgroundImage:`url(${bg})`}} data-speed="0.5">
                ...
                <div className="container relative">
                    <div className="grid lg:grid-cols-12 md:grid-cols-2 mt-10 items-center gap-6">
                        <div className="lg:col-span-7">
                            ...
                            <div className="mt-6">
                                <Link to="" className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-primary text-white rounded-md">View Packages</Link>
                                <Link to="#!" onClick={() => setOpen(true)} className="size-10 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center rounded-full border border-primary bg-primary text-white ms-1 lightbox"><FiVideo className="h-4 w-4"></FiVideo></Link><span className="font-semibold ms-1 align-middle"></span>
                            </div>
                            {isOpen && 
                        ...
                        <div className="lg:col-span-5">
                            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm dark:shadow-gray-800 p-6 z-10 relative lg:ms-10">
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                        <div>
                                            ...
                                            <div className="relative mt-2">
                                                <FiSearch className="size-4.5 absolute top-2.5 inset-s-3"></FiSearch>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative mt-2">
                                                <FiCalendar className="size-4.5 absolute top-2.5 inset-s-3"></FiCalendar>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative mt-2">
                                                <FiUsers className="size-4.5 absolute top-2.5 inset-s-3"></FiUsers>
        ...
        <div className="relative">
            <div className="absolute block w-full h-auto bottom-6.25 z-1 inset-s-0">
                <Link to="#"><i className="ri-arrow-down-s-line absolute top-0 inset-s-0 inset-e-0 text-center inline-flex items-center justify-center rounded-full bg-white dark:bg-slate-900 h-12 w-12 mx-auto shadow-md dark:shadow-gray-800"></i></Link>
            </div>

            <div className="shape absolute sm:-bottom-px -bottom-0.5 inset-s-0 inset-e-0 overflow-hidden text-white dark:text-slate-900">
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
                    {packages.slice(0,8).map((item:Package,index:number)=>{
                        return(
